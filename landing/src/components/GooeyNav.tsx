...
export default function GooeyNav({
  ...
  const showActivePill = (element: HTMLElement) => {
  ...
  useEffect(() => {
    ...
    const activeTarget = activeLi?.querySelector("a") ?? activeLi;
    if (activeTarget) {
      showActivePill(activeTarget);
    }
    ...
    const resizeObserver = new ResizeObserver(() => {
      ...
      const currentTarget = currentActiveLi?.querySelector("a") ?? currentActiveLi;
      if (currentTarget) {
        updateEffectPosition(currentTarget);
      }
    });
