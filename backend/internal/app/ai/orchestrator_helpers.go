...
var (
	...
	caseTimelineSummaryPattern = regexp.MustCompile(`(?i)(vaka özeti|vaka dosyası özeti|son 30 gün.*özet|zaman çizelgesi özeti)`)
	openSupportPlansPattern    = regexp.MustCompile(`(?i)(açık takip plan|açık destek plan)`)
	parentMeetingPrepPattern   = regexp.MustCompile(`(?i)(veli görüşmesi hazırlık|veli görüşmesine hazırlık)`)
