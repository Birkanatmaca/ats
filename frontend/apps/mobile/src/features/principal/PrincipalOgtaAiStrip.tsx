...
const PROMPTS = [
  "Bir sınıfın yoklamasını mı arıyorsun?",
  "Öğrenci mi arıyorsun?",
  "Öğretmen mi arıyorsun?",
  "Ders programına mı bakmak istiyorsun?",
  "Bugünkü devamsızlığı mı kontrol edeceksin?",
  "Hangi sınıfta eksik yoklama var?"
] as const;
...
export function PrincipalOgtaAiStrip() {
