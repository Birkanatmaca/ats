...
import { roleHiddenTabScreens, roleTabConfigs, type TabbedRoleShell } from "@/shared/navigation/roleTabs";
import { tabBarClearance } from "@/shared/navigation/tabBarMetrics";

export function RoleTabLayout({ shell }: { shell: TabbedRoleShell }) {
