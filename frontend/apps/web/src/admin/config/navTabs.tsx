import { Blocks, BrainCircuit, Building2, CreditCard, FileClock, LayoutDashboard, LifeBuoy, Settings2, UsersRound } from "lucide-react";
...
export const navTabs: Array<{ id: AdminTab; label: string; icon: ReactNode }> = [
  ...
  { id: "billing", label: "Faturalama", icon: <CreditCard size={18} /> },
