import { BarChart3, Bell, CalendarDays, CircleDollarSign, ClipboardCheck, FolderOpen, HeartHandshake, LayoutDashboard, ListChecks, School, UserCircle, UserRound, UsersRound, Bus } from "lucide-react";
